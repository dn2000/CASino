class CASino::SessionsController < CASino::ApplicationController
  ...
  def validate_user_exist
    ...
    if !@validation_result
      require 'oauth2'
      client = OAuth2::Client.new('63cc4d99c35957b9accca21c719cc22eb9789f6069fa371617d3676c9dc325e4', '770364babf68a71e72a9ad4026cdac57b13badb805afac02841a78cee1396db4', site: 'http://601efe07e446.ngrok.io')
